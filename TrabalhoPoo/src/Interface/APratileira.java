...
public class APratileira extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("RemoverItem");

        jButton5.setText("ListarItens");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(APratileira.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new APratileira().setVisible(true);
            }
        });
    }
